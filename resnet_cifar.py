...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks, num_classes=10,p=0.0, F_init = 'xavier', init = True):
    ...
    def init_weights(self):
        ...
        print('Param Count for Generator initialized parameters : {:d}'.format(self.param_count))
    ...
    def forward(self, x, out_feature=False):
        ...
        feature = out2.view(out2.size(0), -1)
        out3 = self.linear(feature)
